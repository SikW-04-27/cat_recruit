...
<template>
  ...
  >
    ...
    <el-submenu index="2">
      ...
      <el-menu-item index="2-1"><router-link to="/introduction">报名</router-link></el-menu-item>
      <el-menu-item index="2-2"><router-link to="/introduction">预约面试时间</router-link></el-menu-item>
