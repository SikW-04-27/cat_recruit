  ...
  <div id="form">
    ...
    <div class="content">
      ...
      <div class="commit_btn">
        <el-button type="primary" round @click="btnClick()" :disabled="disabled">提交</el-button>
      </div>
    </div>
  </div>
</template>
...
<script>
import { defineComponent, ref, reactive } from "vue";\/ import submit from "../../request/api.js";
import {
  listAllCollege,
  listAllMajor,
  listMajor,
