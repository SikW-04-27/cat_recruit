    ...
    getSubmit({ uuid: stuId })
      .then((res) => {
        if (res.data) {
          ...
          res.datacollege: institute.value
          res.datadirection: radio1.value
          res.datagender: radio2.value
          res.datamajor: major.value
          res.dataname: name.value
          res.dataphoneNumber: phone.value
          res.dataselfIntroduction: textarea2.value
          res.datastudentId: stuNumber.value,
