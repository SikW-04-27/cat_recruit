<template>
  <div id="form">
    ...
    <!-- 登陆 处于报名阶段 未报名 -->
    <div class="content" v-if="currentStatusId === 2 && stuId">
      <!-- 姓名 -->
      <div class="name">
        <span>姓名：</span>
        <div class="n_input">
    ...
    <!-- 登录 处于报名阶 已报名 -->
    <div class="hasSignUp" v-if="currentStatusId === 2 && stuId">
...
let currentStatus = JSON.parse(window.localStorage.getItem("CurrentStatus"))
  .status;
//判断是否报名
let isSignUp = JSON.parse(window.localStorage.getItem("CurrentStatus"));
//获取学院
