    ...
    getSubmit({ uuid: stuId })
      .then((res) => {
        if (res.data) {
          ...
          res.data.major=major.value
          res.data.name=name.value
          res.data.phoneNumber=phone.value
          res.data.selfIntroduction=textarea2.value
          res.data.studentId=stuNumber.value,
