...
export function openSocket(socketUrl = `http://112.74.33.254:2358/ws/message/`, token = getCookie("studentToken"), customConfig = {onopen: () => {
    console.log("websocket已打开111");
}}) {
    ...
    socket.onopenmergeConfig.onopen
